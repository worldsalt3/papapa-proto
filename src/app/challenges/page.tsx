...
export default function ChallengesPage() {
  ...
  useEffect(() => {
    fetch("/api/wagers?type=DIRECT_CHALLENGE")
      .then((r) => r.json())
    ...
    <>
      ...
      <main className="container-page py-8 pb-24 md:pb-8">
        <div className="flex items-start justify-between mb-6 gap-4">
          <div>
            <h1 className="text-xl font-semibold">Direct challenges</h1>
            <p className="text-sm text-[var(--text-muted)] mt-0.5">
              1v1 wagers. Challenge anyone. Winner takes all.
            </p>
          </div>
        ...
        {loading ? (
          ...
          <EmptyState
            ...
            description="Be the first to post a challenge."
            action={{
